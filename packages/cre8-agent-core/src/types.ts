...
export type WireMessage = { role: 'user' | 'assistant'; content: WireContent[] };
...
export type AgentEvent =
  ...
  | { type: 'tool_use'; id: string; spec: ComponentSpec; caption?: string }
  | { type: 'tool_use_error'; id: string; error: string; spec?: ComponentSpec }
