...
export const RENDER_UI_DECLARATION = {
    name: 'render_ui',
    description: 'Render an A2UI spec (cre8-wc nested tree) inline in the chat. Use for forms, charts, cards, grids, and any interactive UI.',
    parameters: {
        type: Type.OBJECT,
        properties: {
            spec: {
                type: Type.OBJECT,
                description: 'A2UI spec. Root is a single component object with { component, props?, children?, slots?, events? }.',
            },
            caption: {
                type: Type.STRING,
