import '!style-loader!css-loader!sass-loader!./PharmacyHeader.scss';
...
export interface PharmacyHeaderProps extends React.HTMLAttributes<HTMLDivElement> {
  /**
 ...
 */
export const PharmacyHeader = ({ styleModifier, ...other }: PharmacyHeaderProps) => {
  ...
  const componentClassName = classnames('c-pharmacy-header', styleModifier, {
    'cre8-is-active': isActiveVar === true
  });

  return (
    <cre8Header className={componentClassName}>
      <svg className="c-pharmacy-header__logo" xmlns="http://www.w3.org/2000/svg" width="230" height="48" viewBox="0 0 230 48" fill="none">
      ...
      <cre8UtilityNav inverted={true}>
        <cre8UtilityNavItem
          className="c-pharmacy-header__utility-nav-search"
      ...
      <cre8Button
        className="c-pharmacy-header__menu-button"
        size="lg"
        ...
        iconName="menu"
      ></cre8Button>
      <cre8NavContainer slot="bottom" className="c-pharmacy-header__nav-container">
        <cre8PrimaryNav inverted={true} className="c-pharmacy-header__primary-nav">
          <cre8PrimaryNavItem text="Home"></cre8PrimaryNavItem>
          <cre8PrimaryNavItem text="Prescriptions" megaMenu={true}>
            <cre8Grid className="c-pharmacy-header__megamenu-grid" variant="3up">
              <cre8GridItem>
                <cre8Heading headingTagName="h3" className="c-pharmacy-header__heading">
                  Megamenu title
                </cre8Heading>
          ...
          <cre8PrimaryNavItem className="c-pharmacy-header__log-out" text="Log out"></cre8PrimaryNavItem>
        </cre8PrimaryNav>
      </cre8NavContainer>
    </cre8Header>
  );
