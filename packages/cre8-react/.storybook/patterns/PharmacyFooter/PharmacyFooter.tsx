import '!style-loader!css-loader!sass-loader!./PharmacyFooter.scss';
import classnames from 'classnames';
import * as React from 'react';
import { cre8Footer } from '../../../src';

export interface PharmacyFooterProps extends React.HTMLAttributes<HTMLDivElement> {
  /**
 ...
 */
export const PharmacyFooter = ({ styleModifier, ...other }: PharmacyFooterProps) => {
  const componentClassName = classnames('c-pharmacy-footer', styleModifier, {});

  return (
    <cre8Footer className={componentClassName}>
      <div className="c-pharmacy-footer__middle">
        ...
        <p className="c-global-footer__copyright">© 2023 Pharmacy. All Rights Reserved.</p>
      </div>
    </cre8Footer>
  );
};
