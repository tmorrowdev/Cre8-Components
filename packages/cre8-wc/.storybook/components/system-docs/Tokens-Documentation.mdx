...
For full details regarding existing tokens, token construction, and more please refer to the cre8 Design Token Storybook in the left sidebar or visit [cre8 Design Token's Storybook](https://github.com/pages/Pharmacy/cre8-design-tokens/) directly.
