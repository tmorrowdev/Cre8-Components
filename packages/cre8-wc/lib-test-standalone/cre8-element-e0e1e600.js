 ...
 */
const N = globalThis, B = N.ShadowRoot && (N.ShadyCSS === void 0 || N.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, I = Symbol(), W = /* @__PURE__ */ new WeakMap();
let st = class {
  constructor(t, e, s) {
...
const dt = (r) => new st(typeof r == "string" ? r : r + "", void 0, I), Mt = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ut, defineProperty: $t, getOwnPropertyDescriptor: ft, getOwnPropertyNames: _t, getOwnPropertySymbols: At, getPrototypeOf: mt } = Object, _ = globalThis, F = _.trustedTypes, yt = F ? F.emptyScript : "", j = _.reactiveElementPolyfillSupport, w = (r, t) => r, z = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? yt : null;
      break;
  ...
  return e;
} }, it = (r, t) => !ut(r, t), J = { attribute: !0, type: String, converter: z, reflect: !1, useDefault: !1, hasChanged: it };
...
let v = class extends HTMLElement {
  ...
  _$AK(t, e) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const a = s.getPropertyOptions(i), h = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((n = a.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? a.converter : z;
  ...
  requestUpdate(t, e, s) {
    ...
    if (t !== void 0) {
      ...
      if (s ?? (s = n.getPropertyOptions(t)), !((s.hasChanged ?? it)(o, e) || s.useDefault && s.reflect && o === ((i = this._$Ej) == null ? void 0 : i.get(t)) && !this.hasAttribute(n._$Eu(t, s))))
        return;
      this.C(t, e, s);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = globalThis, T = C.trustedTypes, K = T ? T.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, rt = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, nt = "?" + f, gt = `<${nt}>`, g = document, x = () => g.createComment(""), O = (r) => r === null || typeof r != "object" && typeof r != "function", V = Array.isArray, vt = (r) => V(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", k = `[ 	
\f\r]`, b = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Z = /-->/g, G = />/g, A = RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Q = /'/g, X = /"/g, ot = /^(?:script|style|textarea|title)$/i, Et = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), St = Et(1), E = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), Y = /* @__PURE__ */ new WeakMap(), m = g.createTreeWalker(g, 129);
function ht(r, t) {
  if (!V(r) || !r.hasOwnProperty("raw"))
...
const bt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); )
      u = o.lastIndex, o === b ? p[1] === "!--" ? o = Z : p[1] !== void 0 ? o = G : p[2] !== void 0 ? (ot.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = A) : p[3] !== void 0 && (o = A) : o === A ? p[0] === ">" ? (o = i ?? b, l = -1) : p[1] === void 0 ? l = -2 : (l = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? A : p[3] === '"' ? X : Q) : o === X || o === Q ? o = A : o === Z || o === G ? o = b : (o = A, i = void 0);
    const $ = o === A && r[a + 1].startsWith("/>") ? " " : "";
    n += o === b ? h + gt : l >= 0 ? (s.push(c), h.slice(0, l) + rt + h.slice(l) + f + $) : h + f + (l === -2 ? a : $);
  }
      ...
      if (i.nodeType === 1) {
        if (i.hasAttributes())
          for (const l of i.getAttributeNames())
            if (l.endsWith(rt)) {
              ...
              h.push({ type: 1, index: n, name: M[2], strings: $, ctor: M[1] === "." ? Ct : M[1] === "?" ? Pt : M[1] === "@" ? xt : R }), i.removeAttribute(l);
            } else
        ...
        if (ot.test(i.tagName)) {
          ...
          if (u > 0) {
            ...
            for (let $ = 0; $ < u; $++)
              i.append(l[$], x()), m.nextNode(), h.push({ type: 2, index: ++n });
            i.append(l[u], x());
          }
        }
...
class H {
  ...
  _$AI(t, e = this) {
    t = S(this, t, e), O(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== E && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : vt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _$AI(t, e = this, s, i) {
    ...
    if (n === void 0)
      ...
      for (t = n[0], h = 0; h < n.length - 1; h++)
        c = S(this, a[s + h], e, h), c === E && (c = this._$AH[h]), o || (o = !O(c) || c !== this._$AH[h]), c === d ? t = d : t !== d && (t += (c ?? "") + n[h + 1]), this._$AH[h] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
D == null || D(U, H), (C.litHtmlVersions ?? (C.litHtmlVersions = [])).push("3.3.0");
const Ut = (r, t, e) => {
...
var tt;
P._$litElement$ = !0, P.finalized = !0, (tt = y.litElementHydrateSupport) == null || tt.call(y, { LitElement: P });
