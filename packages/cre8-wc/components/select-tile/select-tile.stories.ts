...
import './select-tile';
import svgMedication from '@cre8_dev/cre8-icons/icons/System/Regular/Medication.svg?raw';
...
export default {
  ...
  parameters: {
    withDesign: {
      type: 'figma',
      url: 'https://www.figma.com/file/L8rVyIvYfWAtNpgm2qps73/Cre8-Base-Web-Library?type=design&node-id=3702-28744'
    },
    status: { type: 'beta' },
    controls: {
