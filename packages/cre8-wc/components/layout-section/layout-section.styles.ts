 ...
 * grid. Off by default - see the same note on \`cre8-card--full-height\`:
 * unconditional \`height: 100%\` inside a shadow root composes unpredictably
 * with whatever ancestor ends up establishing the section's containing
 * block.
 */
