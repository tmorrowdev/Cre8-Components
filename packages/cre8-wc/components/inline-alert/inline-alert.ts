...
import svgHelpFilled from '../../icons/System/Filled/Help.svg?raw';
...
export class Cre8InlineAlert extends Cre8Element {
    ...
    * https://digital.cre8.com/patterns-and-Components/informational-display/alerts-and-notifications#query=alerts
