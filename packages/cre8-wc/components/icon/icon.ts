...
import svgArrowLeft from '@cre8_dev/cre8-icons/lib/icons/System/Regular/Arrow_-_Left.svg?raw';
import svgChat from '@cre8_dev/cre8-icons/lib/icons/System/Filled/Chat_Default.svg?raw';
import svgCalendar from '@cre8_dev/cre8-icons/lib/icons/System/Regular/Calendar.svg?raw';
import svgCaretDown from '@cre8_dev/cre8-icons/lib/icons/System/Filled/Caret_Down.svg?raw';
...
import svgMessageFilled from '@cre8_dev/cre8-icons/lib/icons/System/Filled/Message_Unread.svg?raw';
import svgMessage from '@cre8_dev/cre8-icons/lib/icons/System/Regular/Message_Unread.svg?raw';
import svgError from '@cre8_dev/cre8-icons/lib/icons/System/Regular/Error.svg?raw';
import svgExternal from '@cre8_dev/cre8-icons/lib/icons/System/Regular/External_Link.svg?raw';
...
import svgPlayFilled from '@cre8_dev/cre8-icons/lib/icons/System/Filled/Play_Arrow.svg?raw';
import svgPlayCircle from '@cre8_dev/cre8-icons/lib/icons/System/Regular/Play_Circle.svg?raw';
...
import svgCaretDoubleRight from '@cre8_dev/cre8-icons/lib/icons/System/Regular/Caret_Double_Right.svg?raw';
import svgErrorAlt from '@cre8_dev/cre8-icons/lib/icons/error-alt.svg?raw';
import svgPharmacy from '@cre8_dev/cre8-icons/lib/icons/pharmacy.svg?raw';
import svgInsta from '@cre8_dev/cre8-icons/lib/icons/instagram.svg?raw';
import svgLinkedin from '@cre8_dev/cre8-icons/lib/icons/linkedin.svg?raw';
import svgOpen from '@cre8_dev/cre8-icons/lib/icons/open.svg?raw';
import svgPause from '@cre8_dev/cre8-icons/lib/icons/pause.svg?raw';
import svgPersonBubble from '@cre8_dev/cre8-icons/lib/icons/person-bubble.svg?raw';
import svgPinterest from '@cre8_dev/cre8-icons/lib/icons/pinterest.svg?raw';
import svgRss from '@cre8_dev/cre8-icons/lib/icons/rss-feed.svg?raw';
import svgRx from '@cre8_dev/cre8-icons/lib/icons/rx.svg?raw';
import svgSwap from '@cre8_dev/cre8-icons/lib/icons/swap.svg?raw';
import svgThumbsUp from '@cre8_dev/cre8-icons/lib/icons/thumb-up.svg?raw';
import svgTrendFlat from '@cre8_dev/cre8-icons/lib/icons/trending-flat.svg?raw';
import svgTrendUp from '@cre8_dev/cre8-icons/lib/icons/trending-up.svg?raw';
import svgTwitter from '@cre8_dev/cre8-icons/lib/icons/twitter.svg?raw';
...
export class Cre8Icon extends Cre8Element {
    ...
    render() {
        ...
        iconMap['email'] = html`<svg src='${svgMessageFilled}' container-class="${componentClassName}" class="cre8-c-icon" aria-label="${this.iconTitle}" aria-hidden="${!this.iconTitle}"></svg>`;
        ...
        iconMap['pharmacy'] = html`<svg src='${svgPharmacy}' container-class="${componentClassName}" class="cre8-c-icon" aria-label="${this.iconTitle}" aria-hidden="${!this.iconTitle}"></svg>`;
