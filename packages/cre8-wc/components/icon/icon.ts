...
import svgPharmacy from './icons/pharmacy.svg?raw'; // get from cre8-assets in the future?
...
export class cre8IconLegacy extends Cre8Element {
    ...
    render() {
        ...
        iconMap['pharmacy'] = html`<cre8-icon svg='${svgPharmacy}' container-class="${componentClassName}" class="cre8-c-icon" aria-label="${this.iconTitle}" aria-hidden="${!this.iconTitle}"></cre8-icon>`;
