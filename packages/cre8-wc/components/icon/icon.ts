...
import svgPharmacy from '@tmorrow/cre8-wc/icons/pharmacy.svg?raw';
 ...
 * Please see [Importing Icons](https:/docs.cre8.dev/svgs/?path=/story/icon-sets-importing-@tmorrow/cre8-wc/icons--page)
