...
:root {
  ...
  --cre8-color-header-inverse-bg-default: #1a73e8;
  --cre8-color-header-menu-bg-default: #ffffff;
  --cre8-color-header-menu-inverse-bg-default: #1a73e8;
  --cre8-color-header-menu-bg-hover: #f6f5f3;
  --cre8-color-header-menu-inverse-bg-hover: #0d47a1;
  --cre8-color-header-menu-bg-focus: #f6f5f3;
  --cre8-color-header-menu-inverse-bg-focus: #0d47a1;
  --cre8-color-header-menu-bg-active: #edebe7;
  --cre8-color-header-menu-inverse-bg-active: #0a3d8f;
  --cre8-color-header-menu-bg-pressed: #edebe7;
  --cre8-color-header-menu-inverse-bg-pressed: #0a3d8f;
  --cre8-color-header-menu-bg-selected: #f6f5f3;
  --cre8-color-header-menu-inverse-bg-selected: #0d47a1;
  --cre8-color-header-menu-content-default: #1a73e8;
  --cre8-color-header-menu-inverse-content-default: #ffffff;
  --cre8-color-header-menu-content-hover: #0d47a1;
  --cre8-color-header-menu-inverse-content-hover: #ffffff;
  --cre8-color-header-menu-content-focus: #1a73e8;
  --cre8-color-header-menu-inverse-content-focus: #ffffff;
  --cre8-color-header-menu-content-active: #0a3d8f;
  --cre8-color-header-menu-inverse-content-active: #ffffff;
  --cre8-color-header-menu-content-pressed: #0a3d8f;
  --cre8-color-header-menu-inverse-content-pressed: #ffffff;
  --cre8-color-header-menu-content-selected: #0d47a1;
  ...
  --cre8-color-button-primary-inverse-bg: #e8eaf6;
  --cre8-color-button-primary-bg-hover: #0d47a1;
  --cre8-color-button-primary-inverse-bg-hover: #c5cae9;
  --cre8-color-button-primary-bg-active: #0a3d8f;
  --cre8-color-button-primary-inverse-bg-active: #9fa8da;
  ...
  --cre8-color-button-primary-inverse-content: #0d47a1;
  --cre8-color-button-primary-content-hover: #ffffff;
  --cre8-color-button-primary-inverse-content-hover: #0d47a1;
  --cre8-color-button-primary-content-active: #ffffff;
  --cre8-color-button-primary-inverse-content-active: #0d47a1;
  ...
  --cre8-color-button-primary-inverse-border: #e8eaf6;
  --cre8-color-button-primary-border-hover: #0d47a1;
  --cre8-color-button-primary-inverse-border-hover: #c5cae9;
  --cre8-color-button-primary-border-active: #0a3d8f;
  --cre8-color-button-primary-inverse-border-active: #9fa8da;
  --cre8-color-button-primary-border-disabled: #eaeaea;
  --cre8-color-button-primary-inverse-border-disabled: #ababab;
  --cre8-color-button-primary-outline: #0a3d8f;
  --cre8-color-button-primary-inverse-outline: #e8eaf6;
  ...
  --cre8-color-button-primary-danger-outline: #0a3d8f;
  --cre8-color-button-primary-danger-inverse-outline: #e8eaf6;
  ...
  --cre8-color-button-secondary-neutral-outline: #1a73e8;
  --cre8-color-button-secondary-neutral-inverse-outline: #e8eaf6;
  ...
  --cre8-color-button-secondary-bg-active: #e3f2fd;
  --cre8-color-button-secondary-inverse-bg-active: #0a3d8f;
  --cre8-color-button-secondary-bg-disabled: #eaeaea;
  --cre8-color-button-secondary-inverse-bg-disabled: rgba(45, 45, 45, 0.0);
  --cre8-color-button-secondary-content: #1a73e8;
  --cre8-color-button-secondary-inverse-content: #e8eaf6;
  --cre8-color-button-secondary-content-hover: #0d47a1;
  --cre8-color-button-secondary-inverse-content-hover: #c5cae9;
  --cre8-color-button-secondary-content-active: #0a3d8f;
  --cre8-color-button-secondary-inverse-content-active: #9fa8da;
  --cre8-color-button-secondary-content-disabled: #949494;
  --cre8-color-button-secondary-inverse-content-disabled: #ababab;
  --cre8-color-button-secondary-border: #1a73e8;
  --cre8-color-button-secondary-inverse-border: #e8eaf6;
  --cre8-color-button-secondary-border-hover: #0d47a1;
  --cre8-color-button-secondary-inverse-border-hover: #c5cae9;
  --cre8-color-button-secondary-border-active: #0a3d8f;
  --cre8-color-button-secondary-inverse-border-active: #9fa8da;
  --cre8-color-button-secondary-border-disabled: #ababab;
  --cre8-color-button-secondary-inverse-border-disabled: #ababab;
  --cre8-color-button-secondary-outline: #0a3d8f;
  --cre8-color-button-secondary-inverse-outline: #c5cae9;
  ...
  --cre8-color-button-secondary-danger-outline: #0a3d8f;
  --cre8-color-button-secondary-danger-inverse-outline: #e8eaf6;
  ...
  --cre8-color-button-tertiary-inverse-bg-active: #1565c0;
  --cre8-color-button-tertiary-bg-disabled: rgba(45, 45, 45, 0.0);
  --cre8-color-button-tertiary-inverse-bg-disabled: rgba(45, 45, 45, 0.0);
  --cre8-color-button-tertiary-content: #1a73e8;
  --cre8-color-button-tertiary-inverse-content: #e8eaf6;
  --cre8-color-button-tertiary-content-hover: #0d47a1;
  --cre8-color-button-tertiary-inverse-content-hover: #c5cae9;
  --cre8-color-button-tertiary-content-active: #0a3d8f;
  --cre8-color-button-tertiary-inverse-content-active: #9fa8da;
  ...
  --cre8-color-button-tertiary-border-hover: #0d47a1;
  --cre8-color-button-tertiary-inverse-border-hover: #c5cae9;
  --cre8-color-button-tertiary-border-active: #0a3d8f;
  --cre8-color-button-tertiary-inverse-border-active: #9fa8da;
  ...
  --cre8-color-button-tertiary-outline: #0a3d8f;
  --cre8-color-button-tertiary-inverse-outline: #c5cae9;
  ...
  --cre8-color-bg-default-active: #e3f2fd;
  ...
  --cre8-color-bg-brand-active: #bbdefb;
  --cre8-color-bg-brand-hover: #e3f2fd;
  --cre8-color-bg-brand-strong: #1a73e8;
  --cre8-color-bg-brand-strong-hover: #0d47a1;
  --cre8-color-bg-brand-strong-active: #0a3d8f;
  --cre8-color-bg-brand-xstrong: #0d47a1;
  --cre8-color-bg-brand-xstrong-hover: #0a3d8f;
  --cre8-color-bg-brand-xstrong-active: #0a3d8f;
  --cre8-color-bg-success: #e8eaf6;
  --cre8-color-bg-success-strong: #3949ab;
  ...
  --cre8-color-bg-attention-strong: #42a5f5;
  ...
  --cre8-color-content-brand-knockout: #e8eaf6;
  --cre8-color-content-success: #3949ab;
  --cre8-color-content-success-icon: #3949ab;
  ...
  --cre8-color-content-attention-icon: #42a5f5;
  --cre8-color-content-link: #1a73e8;
  --cre8-color-content-inverse-link: #e8eaf6;
  --cre8-color-content-link-hover: #0d47a1;
  --cre8-color-content-inverse-link-hover: #c5cae9;
  ...
  --cre8-color-content-link-active: #0a3d8f;
  --cre8-color-content-inverse-link-active: #9fa8da;
  ...
  --cre8-color-border-brand: #1a73e8;
  --cre8-color-border-brand-subtle: #90caf9;
  --cre8-color-border-brand-strong: #1a73e8;
  --cre8-color-border-success: #5c6bc0;
  --cre8-color-border-error: #e93a3a;
  --cre8-color-border-warning: #e89f12;
  --cre8-color-border-info: #1963e1;
  --cre8-color-border-attention: #42a5f5;
  --cre8-color-border-transparent: rgba(45, 45, 45, 0.0);
  --cre8-color-border-active-outline: #0d47a1;
  --cre8-color-border-inverse-active-outline: #e8eaf6;
  ...
  --cre8-font-families-inter: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-body-xlarge-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-body-xlarge-strong-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-body-xlarge-link-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-body-large-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-body-large-strong-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-body-default-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-body-default-strong-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-body-small-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-body-small-strong-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-body-large-link-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-body-default-link-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-body-small-link-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-label-default-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-label-large-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-label-small-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-title-xlarge-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-title-xlarge-mobile-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-title-large-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-title-large-mobile-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-title-default-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-title-default-mobile-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-title-small-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-title-small-mobile-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-headline-large-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-headline-large-mobile-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-headline-default-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-headline-default-mobile-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-headline-small-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-headline-small-mobile-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-headline-xsmall-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-headline-xsmall-mobile-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-display-large-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-display-large-mobile-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-display-default-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-display-default-mobile-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-display-small-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-display-small-mobile-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-meta-default-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-meta-default-sentence-case-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-meta-large-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
  ...
  --cre8-typography-meta-small-font-family: 'Roboto', 'Helvetica Neue', sans-serif;
