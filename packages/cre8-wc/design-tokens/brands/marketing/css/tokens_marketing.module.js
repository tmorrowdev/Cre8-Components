export default `:root {
  /* ==========================================================================
   * Marketing Theme - Complete Design Token Set
   * Primary: #0033ff (Vivid Blue) | Brand Strong: #110081 (Deep Purple)
   * Font: Montserrat
   * Border Radius: Pill-shaped buttons (900px)
   * ========================================================================== */
  ...
  --cre8-color-button-secondary-inverse-bg: rgba(51, 51, 51, 0.0);
  ...
  --cre8-color-button-secondary-bg-disabled: rgba(51, 51, 51, 0.0);
  --cre8-color-button-secondary-inverse-bg-disabled: rgba(51, 51, 51, 0.0);
   ...
   * ========================================================================== */
  --cre8-color-button-secondary-neutral-bg: rgba(51, 51, 51, 0.0);
  --cre8-color-button-secondary-neutral-inverse-bg: rgba(51, 51, 51, 0.0);
  ...
  --cre8-color-button-secondary-neutral-bg-hover: rgba(51, 51, 51, 0.10);
  --cre8-color-button-secondary-neutral-inverse-bg-hover: rgba(51, 51, 51, 0.20);
  ...
  --cre8-color-button-secondary-neutral-bg-active: rgba(51, 51, 51, 0.20);
  --cre8-color-button-secondary-neutral-inverse-bg-active: rgba(51, 51, 51, 0.50);
   ...
   * ========================================================================== */
  --cre8-color-button-secondary-danger-bg: rgba(51, 51, 51, 0.0);
  --cre8-color-button-secondary-danger-inverse-bg: rgba(51, 51, 51, 0.0);
  ...
  --cre8-color-button-tertiary-inverse-bg: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-bg-hover: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-inverse-bg-hover: rgba(51, 51, 51, 0.0);
  ...
  --cre8-color-button-tertiary-inverse-bg-disabled: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-border: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-inverse-border: rgba(51, 51, 51, 0.0);
  ...
  --cre8-color-button-tertiary-inverse-border-disabled: rgba(51, 51, 51, 0.0);
   ...
   * ========================================================================== */
  --cre8-color-button-tertiary-neutral-bg: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-neutral-inverse-bg: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-neutral-content: #333333;
  --cre8-color-button-tertiary-neutral-inverse-content: #ffffff;
  --cre8-color-button-tertiary-neutral-border: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-neutral-inverse-border: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-neutral-bg-hover: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-neutral-inverse-bg-hover: rgba(51, 51, 51, 0.0);
  ...
  --cre8-color-button-tertiary-neutral-bg-active: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-neutral-inverse-bg-active: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-neutral-content-active: #333333;
  --cre8-color-button-tertiary-neutral-inverse-content-active: #ffffff;
  --cre8-color-button-tertiary-neutral-bg-disabled: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-neutral-inverse-bg-disabled: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-neutral-border-disabled: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-neutral-inverse-border-disabled: rgba(51, 51, 51, 0.0);
   ...
   * ========================================================================== */
  --cre8-color-button-tertiary-danger-bg: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-danger-inverse-bg: rgba(51, 51, 51, 0.0);
  ...
  --cre8-color-button-tertiary-danger-border: rgba(51, 51, 51, 0.0);
  --cre8-color-button-tertiary-danger-inverse-border: rgba(51, 51, 51, 0.0);
   ...
   * TYPOGRAPHY
   * ========================================================================== */
  --cre8-font-family-default: "Montserrat", sans-serif;
