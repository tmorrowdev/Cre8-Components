...
:root {
  ...
  --cre8-color-header-inverse-bg-default: #003366;
  --cre8-color-header-menu-bg-default: #ffffff;
  --cre8-color-header-menu-inverse-bg-default: #003366;
  --cre8-color-header-menu-bg-hover: #f6f5f3;
  --cre8-color-header-menu-inverse-bg-hover: #001a33;
  --cre8-color-header-menu-bg-focus: #f6f5f3;
  --cre8-color-header-menu-inverse-bg-focus: #001a33;
  --cre8-color-header-menu-bg-active: #edebe7;
  --cre8-color-header-menu-inverse-bg-active: #001122;
  --cre8-color-header-menu-bg-pressed: #edebe7;
  --cre8-color-header-menu-inverse-bg-pressed: #001122;
  --cre8-color-header-menu-bg-selected: #f6f5f3;
  --cre8-color-header-menu-inverse-bg-selected: #001a33;
  --cre8-color-header-menu-content-default: #003366;
  --cre8-color-header-menu-inverse-content-default: #ffffff;
  --cre8-color-header-menu-content-hover: #001a33;
  --cre8-color-header-menu-inverse-content-hover: #ffffff;
  --cre8-color-header-menu-content-focus: #003366;
  --cre8-color-header-menu-inverse-content-focus: #ffffff;
  --cre8-color-header-menu-content-active: #001122;
  --cre8-color-header-menu-inverse-content-active: #ffffff;
  --cre8-color-header-menu-content-pressed: #001122;
  --cre8-color-header-menu-inverse-content-pressed: #ffffff;
  --cre8-color-header-menu-content-selected: #001a33;
  ...
  --cre8-color-button-primary-bg: #003366;
  --cre8-color-button-primary-inverse-bg: #b3ccdd;
  --cre8-color-button-primary-bg-hover: #001a33;
  --cre8-color-button-primary-inverse-bg-hover: #99bbcc;
  --cre8-color-button-primary-bg-active: #001122;
  --cre8-color-button-primary-inverse-bg-active: #7faabb;
  ...
  --cre8-color-button-primary-inverse-content: #001a33;
  --cre8-color-button-primary-content-hover: #ffffff;
  --cre8-color-button-primary-inverse-content-hover: #001a33;
  --cre8-color-button-primary-content-active: #ffffff;
  --cre8-color-button-primary-inverse-content-active: #001a33;
  --cre8-color-button-primary-content-disabled: #949494;
  --cre8-color-button-primary-inverse-content-disabled: #6c6c6c;
  --cre8-color-button-primary-border: #003366;
  --cre8-color-button-primary-inverse-border: #b3ccdd;
  --cre8-color-button-primary-border-hover: #001a33;
  --cre8-color-button-primary-inverse-border-hover: #99bbcc;
  --cre8-color-button-primary-border-active: #001122;
  --cre8-color-button-primary-inverse-border-active: #7faabb;
  --cre8-color-button-primary-border-disabled: #eaeaea;
  --cre8-color-button-primary-inverse-border-disabled: #ababab;
  --cre8-color-button-primary-outline: #001122;
  --cre8-color-button-primary-inverse-outline: #b3ccdd;
  ...
  --cre8-color-button-primary-danger-outline: #001122;
  --cre8-color-button-primary-danger-inverse-outline: #b3ccdd;
  ...
  --cre8-color-button-secondary-neutral-outline: #003366;
  --cre8-color-button-secondary-neutral-inverse-outline: #b3ccdd;
  ...
  --cre8-color-button-secondary-bg-active: #e6eef7;
  --cre8-color-button-secondary-inverse-bg-active: #001122;
  --cre8-color-button-secondary-bg-disabled: #eaeaea;
  --cre8-color-button-secondary-inverse-bg-disabled: rgba(45, 45, 45, 0.0);
  --cre8-color-button-secondary-content: #003366;
  --cre8-color-button-secondary-inverse-content: #b3ccdd;
  --cre8-color-button-secondary-content-hover: #001a33;
  --cre8-color-button-secondary-inverse-content-hover: #99bbcc;
  --cre8-color-button-secondary-content-active: #001122;
  --cre8-color-button-secondary-inverse-content-active: #7faabb;
  --cre8-color-button-secondary-content-disabled: #949494;
  --cre8-color-button-secondary-inverse-content-disabled: #ababab;
  --cre8-color-button-secondary-border: #003366;
  --cre8-color-button-secondary-inverse-border: #b3ccdd;
  --cre8-color-button-secondary-border-hover: #001a33;
  --cre8-color-button-secondary-inverse-border-hover: #99bbcc;
  --cre8-color-button-secondary-border-active: #001122;
  --cre8-color-button-secondary-inverse-border-active: #7faabb;
  --cre8-color-button-secondary-border-disabled: #ababab;
  --cre8-color-button-secondary-inverse-border-disabled: #ababab;
  --cre8-color-button-secondary-outline: #001122;
  --cre8-color-button-secondary-inverse-outline: #99bbcc;
  ...
  --cre8-color-button-secondary-danger-outline: #001122;
  --cre8-color-button-secondary-danger-inverse-outline: #b3ccdd;
  ...
  --cre8-color-button-tertiary-inverse-bg-active: #004488;
  --cre8-color-button-tertiary-bg-disabled: rgba(45, 45, 45, 0.0);
  --cre8-color-button-tertiary-inverse-bg-disabled: rgba(45, 45, 45, 0.0);
  --cre8-color-button-tertiary-content: #003366;
  --cre8-color-button-tertiary-inverse-content: #b3ccdd;
  --cre8-color-button-tertiary-content-hover: #001a33;
  --cre8-color-button-tertiary-inverse-content-hover: #99bbcc;
  --cre8-color-button-tertiary-content-active: #001122;
  --cre8-color-button-tertiary-inverse-content-active: #7faabb;
  ...
  --cre8-color-button-tertiary-border-hover: #001a33;
  --cre8-color-button-tertiary-inverse-border-hover: #99bbcc;
  --cre8-color-button-tertiary-border-active: #001122;
  --cre8-color-button-tertiary-inverse-border-active: #7faabb;
  ...
  --cre8-color-button-tertiary-outline: #001122;
  --cre8-color-button-tertiary-inverse-outline: #99bbcc;
  ...
  --cre8-color-bg-default-active: #e6eef7;
  ...
  --cre8-color-bg-brand-active: #ccddef;
  --cre8-color-bg-brand-hover: #e6eef7;
  --cre8-color-bg-brand-strong: #003366;
  --cre8-color-bg-brand-strong-hover: #001a33;
  --cre8-color-bg-brand-strong-active: #001122;
  --cre8-color-bg-brand-xstrong: #001a33;
  --cre8-color-bg-brand-xstrong-hover: #001122;
  --cre8-color-bg-brand-xstrong-active: #001122;
  --cre8-color-bg-success: #eef3f7;
  --cre8-color-bg-success-strong: #2c5f8a;
  ...
  --cre8-color-bg-attention-strong: #336699;
  ...
  --cre8-color-content-brand: #003366;
  --cre8-color-content-brand-strong: #003366;
  --cre8-color-content-brand-knockout: #eef3f7;
  --cre8-color-content-success: #2c5f8a;
  --cre8-color-content-success-icon: #2c5f8a;
  ...
  --cre8-color-content-attention-icon: #336699;
  --cre8-color-content-link: #003366;
  --cre8-color-content-inverse-link: #b3ccdd;
  --cre8-color-content-link-hover: #001a33;
  --cre8-color-content-inverse-link-hover: #99bbcc;
  ...
  --cre8-color-content-link-active: #001122;
  --cre8-color-content-inverse-link-active: #7faabb;
  ...
  --cre8-color-border-brand: #003366;
  --cre8-color-border-brand-subtle: #6699cc;
  --cre8-color-border-brand-strong: #003366;
  --cre8-color-border-success: #4488aa;
  --cre8-color-border-error: #e93a3a;
  --cre8-color-border-warning: #e89f12;
  --cre8-color-border-info: #1963e1;
  --cre8-color-border-attention: #336699;
  --cre8-color-border-transparent: rgba(45, 45, 45, 0.0);
  --cre8-color-border-active-outline: #001a33;
  --cre8-color-border-inverse-active-outline: #b3ccdd;
  ...
  --cre8-font-families-inter: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-body-xlarge-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-body-xlarge-strong-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-body-xlarge-link-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-body-large-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-body-large-strong-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-body-default-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-body-default-strong-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-body-small-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-body-small-strong-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-body-large-link-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-body-default-link-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-body-small-link-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-label-default-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-label-large-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-label-small-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-title-xlarge-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-title-xlarge-mobile-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-title-large-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-title-large-mobile-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-title-default-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-title-default-mobile-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-title-small-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-title-small-mobile-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-headline-large-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-headline-large-mobile-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-headline-default-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-headline-default-mobile-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-headline-small-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-headline-small-mobile-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-headline-xsmall-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-headline-xsmall-mobile-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-display-large-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-display-large-mobile-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-display-default-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-display-default-mobile-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-display-small-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-display-small-mobile-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-meta-default-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-meta-default-sentence-case-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-meta-large-font-family: 'Georgia', 'Times New Roman', serif;
  ...
  --cre8-typography-meta-small-font-family: 'Georgia', 'Times New Roman', serif;
