...
:root {
  ...
  --cre8-color-header-inverse-bg-default: #333333;
  --cre8-color-header-menu-bg-default: #ffffff;
  --cre8-color-header-menu-inverse-bg-default: #333333;
  --cre8-color-header-menu-bg-hover: #f6f5f3;
  --cre8-color-header-menu-inverse-bg-hover: #1a1a1a;
  --cre8-color-header-menu-bg-focus: #f6f5f3;
  --cre8-color-header-menu-inverse-bg-focus: #1a1a1a;
  --cre8-color-header-menu-bg-active: #edebe7;
  --cre8-color-header-menu-inverse-bg-active: #111111;
  --cre8-color-header-menu-bg-pressed: #edebe7;
  --cre8-color-header-menu-inverse-bg-pressed: #111111;
  --cre8-color-header-menu-bg-selected: #f6f5f3;
  --cre8-color-header-menu-inverse-bg-selected: #1a1a1a;
  --cre8-color-header-menu-content-default: #333333;
  --cre8-color-header-menu-inverse-content-default: #ffffff;
  --cre8-color-header-menu-content-hover: #1a1a1a;
  --cre8-color-header-menu-inverse-content-hover: #ffffff;
  --cre8-color-header-menu-content-focus: #333333;
  --cre8-color-header-menu-inverse-content-focus: #ffffff;
  --cre8-color-header-menu-content-active: #111111;
  --cre8-color-header-menu-inverse-content-active: #ffffff;
  --cre8-color-header-menu-content-pressed: #111111;
  --cre8-color-header-menu-inverse-content-pressed: #ffffff;
  --cre8-color-header-menu-content-selected: #1a1a1a;
  ...
  --cre8-color-header-menu-border-focus: #1a1a1a;
  ...
  --cre8-color-header-menu-border-selected: #1a1a1a;
  --cre8-color-header-menu-inverse-border-selected: #f6f5f3;
  --cre8-color-header-submenu-bg-default: #ffffff;
  --cre8-color-header-submenu-inverse-bg-default: #333333;
  --cre8-color-header-submenu-bg-hover: #f6f5f3;
  --cre8-color-header-submenu-inverse-bg-hover: #1a1a1a;
  ...
  --cre8-color-header-submenu-inverse-border-hover: #1a1a1a;
  ...
  --cre8-color-header-submenu-inverse-border-active: #111111;
  --cre8-color-header-submenu-border-pressed: #edebe7;
  --cre8-color-header-submenu-inverse-border-pressed: #111111;
  --cre8-color-header-submenu-border-selected: #1a1a1a;
  --cre8-color-header-submenu-inverse-border-selected: #f6f5f3;
  --cre8-color-header-bg-secondary: #333333;
  ...
  --cre8-color-footer-link-hover: #111111;
  --cre8-color-footer-link-default: #111111;
  --cre8-spacing-0: 0rem;
  ...
  --cre8-color-button-primary-bg: #333333;
  --cre8-color-button-primary-inverse-bg: #e0e0e0;
  --cre8-color-button-primary-bg-hover: #1a1a1a;
  --cre8-color-button-primary-inverse-bg-hover: #cccccc;
  --cre8-color-button-primary-bg-active: #111111;
  --cre8-color-button-primary-inverse-bg-active: #b3b3b3;
  ...
  --cre8-color-button-primary-inverse-content: #1a1a1a;
  --cre8-color-button-primary-content-hover: #ffffff;
  --cre8-color-button-primary-inverse-content-hover: #1a1a1a;
  --cre8-color-button-primary-content-active: #ffffff;
  --cre8-color-button-primary-inverse-content-active: #1a1a1a;
  --cre8-color-button-primary-content-disabled: #949494;
  --cre8-color-button-primary-inverse-content-disabled: #6c6c6c;
  --cre8-color-button-primary-border: #333333;
  --cre8-color-button-primary-inverse-border: #e0e0e0;
  --cre8-color-button-primary-border-hover: #1a1a1a;
  --cre8-color-button-primary-inverse-border-hover: #cccccc;
  --cre8-color-button-primary-border-active: #111111;
  --cre8-color-button-primary-inverse-border-active: #b3b3b3;
  --cre8-color-button-primary-border-disabled: #eaeaea;
  --cre8-color-button-primary-inverse-border-disabled: #ababab;
  --cre8-color-button-primary-outline: #111111;
  --cre8-color-button-primary-inverse-outline: #e0e0e0;
  ...
  --cre8-color-button-primary-danger-outline: #111111;
  --cre8-color-button-primary-danger-inverse-outline: #e0e0e0;
  ...
  --cre8-color-button-secondary-neutral-inverse-outline: #e0e0e0;
  ...
  --cre8-color-button-secondary-bg-active: #f5f5f5;
  --cre8-color-button-secondary-inverse-bg-active: #111111;
  --cre8-color-button-secondary-bg-disabled: #eaeaea;
  --cre8-color-button-secondary-inverse-bg-disabled: rgba(45, 45, 45, 0.0);
  --cre8-color-button-secondary-content: #333333;
  --cre8-color-button-secondary-inverse-content: #e0e0e0;
  --cre8-color-button-secondary-content-hover: #1a1a1a;
  --cre8-color-button-secondary-inverse-content-hover: #cccccc;
  --cre8-color-button-secondary-content-active: #111111;
  --cre8-color-button-secondary-inverse-content-active: #b3b3b3;
  --cre8-color-button-secondary-content-disabled: #949494;
  --cre8-color-button-secondary-inverse-content-disabled: #ababab;
  --cre8-color-button-secondary-border: #333333;
  --cre8-color-button-secondary-inverse-border: #e0e0e0;
  --cre8-color-button-secondary-border-hover: #1a1a1a;
  --cre8-color-button-secondary-inverse-border-hover: #cccccc;
  --cre8-color-button-secondary-border-active: #111111;
  --cre8-color-button-secondary-inverse-border-active: #b3b3b3;
  --cre8-color-button-secondary-border-disabled: #ababab;
  --cre8-color-button-secondary-inverse-border-disabled: #ababab;
  --cre8-color-button-secondary-outline: #111111;
  ...
  --cre8-color-button-secondary-danger-outline: #111111;
  --cre8-color-button-secondary-danger-inverse-outline: #e0e0e0;
  ...
  --cre8-color-button-tertiary-inverse-bg-active: #444444;
  --cre8-color-button-tertiary-bg-disabled: rgba(45, 45, 45, 0.0);
  --cre8-color-button-tertiary-inverse-bg-disabled: rgba(45, 45, 45, 0.0);
  --cre8-color-button-tertiary-content: #333333;
  --cre8-color-button-tertiary-inverse-content: #e0e0e0;
  --cre8-color-button-tertiary-content-hover: #1a1a1a;
  --cre8-color-button-tertiary-inverse-content-hover: #cccccc;
  --cre8-color-button-tertiary-content-active: #111111;
  --cre8-color-button-tertiary-inverse-content-active: #b3b3b3;
  ...
  --cre8-color-button-tertiary-border-hover: #1a1a1a;
  --cre8-color-button-tertiary-inverse-border-hover: #cccccc;
  --cre8-color-button-tertiary-border-active: #111111;
  --cre8-color-button-tertiary-inverse-border-active: #b3b3b3;
  ...
  --cre8-color-button-tertiary-outline: #111111;
  ...
  --cre8-color-bg-default-active: #f5f5f5;
  ...
  --cre8-color-bg-brand-active: #eeeeee;
  --cre8-color-bg-brand-hover: #f5f5f5;
  --cre8-color-bg-brand-strong: #333333;
  --cre8-color-bg-brand-strong-hover: #1a1a1a;
  --cre8-color-bg-brand-strong-active: #111111;
  --cre8-color-bg-brand-xstrong: #1a1a1a;
  --cre8-color-bg-brand-xstrong-hover: #111111;
  --cre8-color-bg-brand-xstrong-active: #111111;
  --cre8-color-bg-success: #f0f0f0;
  --cre8-color-bg-success-strong: #555555;
  ...
  --cre8-color-bg-attention-strong: #666666;
  ...
  --cre8-color-content-brand: #333333;
  --cre8-color-content-brand-strong: #333333;
  --cre8-color-content-brand-knockout: #f0f0f0;
  --cre8-color-content-success: #555555;
  --cre8-color-content-success-icon: #555555;
  ...
  --cre8-color-content-attention-icon: #666666;
  --cre8-color-content-link: #333333;
  --cre8-color-content-inverse-link: #e0e0e0;
  --cre8-color-content-link-hover: #1a1a1a;
  ...
  --cre8-color-content-link-active: #111111;
  --cre8-color-content-inverse-link-active: #b3b3b3;
  ...
  --cre8-color-border-brand: #333333;
  --cre8-color-border-brand-subtle: #999999;
  --cre8-color-border-brand-strong: #333333;
  --cre8-color-border-success: #888888;
  --cre8-color-border-error: #e93a3a;
  --cre8-color-border-warning: #e89f12;
  --cre8-color-border-info: #1963e1;
  --cre8-color-border-attention: #666666;
  --cre8-color-border-transparent: rgba(45, 45, 45, 0.0);
  --cre8-color-border-active-outline: #1a1a1a;
  --cre8-color-border-inverse-active-outline: #e0e0e0;
  ...
  --cre8-font-families-inter: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-body-xlarge-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-body-xlarge-strong-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-body-xlarge-link-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-body-large-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-body-large-strong-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-body-default-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-body-default-strong-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-body-small-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-body-small-strong-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-body-large-link-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-body-default-link-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-body-small-link-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-label-default-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-label-large-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-label-small-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-title-xlarge-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-title-xlarge-mobile-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-title-large-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-title-large-mobile-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-title-default-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-title-default-mobile-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-title-small-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-title-small-mobile-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-headline-large-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-headline-large-mobile-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-headline-default-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-headline-default-mobile-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-headline-small-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-headline-small-mobile-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-headline-xsmall-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-headline-xsmall-mobile-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-display-large-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-display-large-mobile-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-display-default-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-display-default-mobile-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-display-small-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-display-small-mobile-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-meta-default-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-meta-default-sentence-case-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-meta-large-font-family: system-ui, -apple-system, sans-serif;
  ...
  --cre8-typography-meta-small-font-family: system-ui, -apple-system, sans-serif;
