/**
 * Cre8 Legacy Theme - Complete Token Set
 * =======================================
 *
 * Brand Colors:
 * - Primary: #0170bc (Blue)
 * - Brand Strong: #014371 (Dark Navy Blue)
 *
 * Design Characteristics:
 * - Light mode primary UI
 * - Pill-shaped buttons (900px radius)
 * - Montserrat + Open Sans fonts
 * - Rounded containers (30px)
 */
...
export default `:root {
  ...
  --cre8-color-button-secondary-inverse-bg: rgba(40, 44, 47, 0.0);
  --cre8-color-button-secondary-bg-hover: #f2f8fb;
  --cre8-color-button-secondary-inverse-bg-hover: #f2f8fb;
  --cre8-color-button-secondary-bg-active: #f2f8fb;
  --cre8-color-button-secondary-inverse-bg-active: #f2f8fb;
  --cre8-color-button-secondary-bg-disabled: rgba(40, 44, 47, 0.0);
  --cre8-color-button-secondary-inverse-bg-disabled: rgba(40, 44, 47, 0.0);
  --cre8-color-button-secondary-border: #0170bc;
  --cre8-color-button-secondary-inverse-border: #0170bc;
  --cre8-color-button-secondary-border-hover: #0170bc;
  --cre8-color-button-secondary-inverse-border-hover: #0170bc;
  --cre8-color-button-secondary-border-active: #0170bc;
  --cre8-color-button-secondary-inverse-border-active: #0170bc;
  --cre8-color-button-secondary-border-disabled: #72aad0;
  --cre8-color-button-secondary-inverse-border-disabled: #72aad0;
  --cre8-color-button-secondary-content: #0170bc;
  --cre8-color-button-secondary-inverse-content: #0170bc;
  --cre8-color-button-secondary-content-hover: #0170bc;
  --cre8-color-button-secondary-inverse-content-hover: #0170bc;
  --cre8-color-button-secondary-content-active: #0170bc;
  --cre8-color-button-secondary-inverse-content-active: #0170bc;
  --cre8-color-button-secondary-content-disabled: #72aad0;
  --cre8-color-button-secondary-inverse-content-disabled: #72aad0;
  --cre8-color-button-secondary-outline: #282c2f;
  --cre8-color-button-secondary-inverse-outline: #282c2f;
  ...
  --cre8-color-button-tertiary-inverse-bg: rgba(40, 44, 47, 0.0);
  --cre8-color-button-tertiary-bg-hover: rgba(40, 44, 47, 0.0);
  --cre8-color-button-tertiary-inverse-bg-hover: rgba(40, 44, 47, 0.0);
  --cre8-color-button-tertiary-bg-active: #f2f8fb;
  --cre8-color-button-tertiary-inverse-bg-active: #f2f8fb;
  --cre8-color-button-tertiary-bg-disabled: rgba(40, 44, 47, 0.0);
  --cre8-color-button-tertiary-inverse-bg-disabled: rgba(40, 44, 47, 0.0);
  --cre8-color-button-tertiary-border: rgba(40, 44, 47, 0.0);
  --cre8-color-button-tertiary-inverse-border: rgba(40, 44, 47, 0.0);
  --cre8-color-button-tertiary-border-hover: #0170bc;
  --cre8-color-button-tertiary-inverse-border-hover: #0170bc;
  --cre8-color-button-tertiary-border-active: #0170bc;
  --cre8-color-button-tertiary-inverse-border-active: #0170bc;
  --cre8-color-button-tertiary-border-disabled: rgba(40, 44, 47, 0.0);
  --cre8-color-button-tertiary-inverse-border-disabled: rgba(40, 44, 47, 0.0);
  --cre8-color-button-tertiary-content: #0170bc;
  --cre8-color-button-tertiary-inverse-content: #0170bc;
  --cre8-color-button-tertiary-content-hover: #0170bc;
  --cre8-color-button-tertiary-inverse-content-hover: #0170bc;
  --cre8-color-button-tertiary-content-active: #0170bc;
  --cre8-color-button-tertiary-inverse-content-active: #0170bc;
  --cre8-color-button-tertiary-content-disabled: #c4c9cf;
  --cre8-color-button-tertiary-inverse-content-disabled: #c4c9cf;
  --cre8-color-button-tertiary-outline: #282c2f;
  --cre8-color-button-tertiary-inverse-outline: #282c2f;
  ...
  --cre8-color-header-menu-inverse-border-hover: #014371;
