export default `:root {
  /* ==========================================================================
   * Prisma Theme - Complete Design Token Set
   * Primary: #25A55A (Green) | Brand Strong: #1F8A48
   * Accent: #5E81F4 (Blue)
   * Font: Inter
  ...
  --cre8-color-bg-knockout: #000624;
  --cre8-color-bg-strong: #000624;
  --cre8-color-bg-disabled: #ECEFF3;
  --cre8-color-bg-active: #196F3C;
  ...
  --cre8-color-bg-attention: #ebf2ff;
  --cre8-color-bg-attention-strong: #5E81F4;
  ...
  --cre8-color-content-brand-strong: #196F3C;
  --cre8-color-content-brand-knockout: #D6F8E3;

  /* Semantic Content Colors */
  --cre8-color-content-success: #196F3C;
  ...
  --cre8-color-border-brand-subtle: #D6F8E3;
  --cre8-color-border-brand-strong: #196F3C;
  --cre8-color-border-success: #25A55A;
  --cre8-color-border-error: #d02525;
  --cre8-color-border-warning: #e89f12;
  --cre8-color-border-info: #1963e1;
  --cre8-color-border-attention: #5E81F4;
  --cre8-color-border-transparent: rgba(45, 45, 45, 0.0);
  --cre8-color-border-active-outline: #196F3C;
  --cre8-color-link-bg-active: #196F3C;
  ...
  --cre8-color-button-primary-danger-inverse-bg: #ffebeb;
  --cre8-color-button-primary-danger-bg-hover: #a81d1d;
  --cre8-color-button-primary-danger-inverse-bg-hover: #ffc9c9;
  --cre8-color-button-primary-danger-bg-active: #7f1616;
  --cre8-color-button-primary-danger-inverse-bg-active: #ffaaaa;
  --cre8-color-button-primary-danger-bg-disabled: #ECEFF3;
  --cre8-color-button-primary-danger-inverse-bg-disabled: #ababab;
  --cre8-color-button-primary-danger-content: #ffffff;
  --cre8-color-button-primary-danger-inverse-content: #7f1616;
  --cre8-color-button-primary-danger-content-hover: #ffffff;
  --cre8-color-button-primary-danger-inverse-content-hover: #7f1616;
  --cre8-color-button-primary-danger-content-active: #ffffff;
  --cre8-color-button-primary-danger-inverse-content-active: #7f1616;
  ...
  --cre8-color-button-primary-danger-inverse-border: #ffebeb;
  --cre8-color-button-primary-danger-border-hover: #a81d1d;
  --cre8-color-button-primary-danger-inverse-border-hover: #ffc9c9;
  --cre8-color-button-primary-danger-border-active: #7f1616;
  --cre8-color-button-primary-danger-inverse-border-active: #ffaaaa;
  --cre8-color-button-primary-danger-border-disabled: #ECEFF3;
  --cre8-color-button-primary-danger-inverse-border-disabled: #ababab;
  --cre8-color-button-primary-danger-outline: #d02525;
  --cre8-color-button-primary-danger-inverse-outline: #ffebeb;
  ...
  --cre8-color-button-secondary-bg-hover: #D6F8E3;
  --cre8-color-button-secondary-inverse-bg-hover: rgba(255, 255, 255, 0.15);
  --cre8-color-button-secondary-bg-active: #B8EEC9;
  --cre8-color-button-secondary-inverse-bg-active: rgba(255, 255, 255, 0.25);
  --cre8-color-button-secondary-bg-disabled: rgba(45, 45, 45, 0.0);
  ...
  --cre8-color-button-secondary-border-hover: #25A55A;
  --cre8-color-button-secondary-inverse-border-hover: #ffffff;
  --cre8-color-button-secondary-border-active: #25A55A;
  ...
  --cre8-color-button-secondary-content-hover: #25A55A;
  --cre8-color-button-secondary-inverse-content-hover: #ffffff;
  --cre8-color-button-secondary-content-active: #25A55A;
  --cre8-color-button-secondary-inverse-content-active: #ffffff;
  --cre8-color-button-secondary-content-disabled: #ababab;
  ...
  --cre8-color-button-secondary-neutral-bg-disabled: #ECEFF3;
  --cre8-color-button-secondary-neutral-inverse-bg-disabled: #ababab;
  --cre8-color-button-secondary-neutral-border-disabled: #ECEFF3;
  ...
  --cre8-color-button-secondary-neutral-outline: #196F3C;
  ...
  --cre8-color-button-secondary-danger-bg-hover: #a81d1d;
  --cre8-color-button-secondary-danger-inverse-bg-hover: #ffc9c9;
  --cre8-color-button-secondary-danger-bg-active: #7f1616;
  --cre8-color-button-secondary-danger-inverse-bg-active: #ffaaaa;
  --cre8-color-button-secondary-danger-bg-disabled: #ECEFF3;
  --cre8-color-button-secondary-danger-inverse-bg-disabled: #ababab;
  --cre8-color-button-secondary-danger-content: #d02525;
  --cre8-color-button-secondary-danger-inverse-content: #ffebeb;
  --cre8-color-button-secondary-danger-content-hover: #ffffff;
  --cre8-color-button-secondary-danger-inverse-content-hover: #7f1616;
  --cre8-color-button-secondary-danger-content-active: #ffffff;
  --cre8-color-button-secondary-danger-inverse-content-active: #7f1616;
  ...
  --cre8-color-button-secondary-danger-inverse-border: #ffebeb;
  --cre8-color-button-secondary-danger-border-hover: #a81d1d;
  --cre8-color-button-secondary-danger-inverse-border-hover: #ffc9c9;
  --cre8-color-button-secondary-danger-border-active: #7f1616;
  --cre8-color-button-secondary-danger-inverse-border-active: #ffaaaa;
  --cre8-color-button-secondary-danger-border-disabled: #ECEFF3;
  --cre8-color-button-secondary-danger-inverse-border-disabled: #ababab;
  --cre8-color-button-secondary-danger-outline: #d02525;
  --cre8-color-button-secondary-danger-inverse-outline: #ffebeb;
  ...
  --cre8-color-button-tertiary-bg-active: #D6F8E3;
  ...
  --cre8-color-button-tertiary-border-hover: #25A55A;
  --cre8-color-button-tertiary-inverse-border-hover: #ffffff;
  --cre8-color-button-tertiary-border-active: #25A55A;
  ...
  --cre8-color-button-tertiary-neutral-outline: #196F3C;
  ...
  --cre8-color-button-tertiary-danger-bg-hover: #a81d1d;
  --cre8-color-button-tertiary-danger-inverse-bg-hover: #ffc9c9;
  --cre8-color-button-tertiary-danger-bg-active: #7f1616;
  --cre8-color-button-tertiary-danger-inverse-bg-active: #ffaaaa;
  --cre8-color-button-tertiary-danger-bg-disabled: #ECEFF3;
  --cre8-color-button-tertiary-danger-inverse-bg-disabled: #ababab;
  --cre8-color-button-tertiary-danger-content: #d02525;
  --cre8-color-button-tertiary-danger-inverse-content: #ffebeb;
  --cre8-color-button-tertiary-danger-content-hover: #ffffff;
  --cre8-color-button-tertiary-danger-inverse-content-hover: #7f1616;
  --cre8-color-button-tertiary-danger-content-active: #ffffff;
  --cre8-color-button-tertiary-danger-inverse-content-active: #7f1616;
  ...
  --cre8-color-button-tertiary-danger-border-hover: #a81d1d;
  --cre8-color-button-tertiary-danger-inverse-border-hover: #ffc9c9;
  --cre8-color-button-tertiary-danger-border-active: #7f1616;
  --cre8-color-button-tertiary-danger-inverse-border-active: #ffaaaa;
  --cre8-color-button-tertiary-danger-border-disabled: #ECEFF3;
  --cre8-color-button-tertiary-danger-inverse-border-disabled: #ababab;
  --cre8-color-button-tertiary-danger-outline: #d02525;
  --cre8-color-button-tertiary-danger-inverse-outline: #ffebeb;
  ...
  --cre8-border-button-tertiary-hover: 2px solid #25A55A;
  --cre8-border-button-tertiary-active: 2px solid #25A55A;
  ...
  --cre8-shadow-small: 0 1px 2px 1px rgba(0,0,0,0.1);
  --cre8-shadow-default: 0 4px 8px 0 rgba(0,0,0,0.1);
  --cre8-shadow-large: 0 8px 16px 0 rgba(0,0,0,0.15);
