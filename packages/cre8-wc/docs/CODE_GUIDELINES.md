...
cre8 Web Components is the web component implementation of cre8. It provides presentational UI components to be consumed by Cre8 web applications.
...
- Clarify the source of the code, distinguishing Cre8 markup/styles from code coming from other codebases and libraries.
