import{j as l}from"./jsx-runtime-u17CrQMm.js";import{e as n}from"./iframe-Dw2Cn1fl.js";import{ai as i}from"./Cre8UtilityNavItem-QDhzibIf.js";import{w as d}from"./decorator-CEKUKXHG.js";import"./preload-helper-PPVm8Dsz.js";const D={title:"In Development/MultiSelect",component:i,parameters:{status:{type:"inProgress"},controls:{exclude:new RegExp(`${n.join("|")}`)},actions:{handles:["multi-select-change"]},docs:{story:{height:"350px"}},decorators:[d]},render:m=>l.jsx(i,{...m}),args:{id:"selectId",label:"Choose you favorite food:",items:["Bagel","Burger","Boat","Beefstick","Bacon"]}},r={args:{}},e=m=>l.jsx("div",{style:{width:"320px"},children:l.jsx(i,{items:["Bagel","Burger","Boat","Beefstick","Bacon"],label:"Wrapping"})}),s={args:{label:"PreSelected",items:["Car","Crumbs","Coco","Creampuff","Clock"],preselectedItems:["Car","Crumbs"]}},a={args:{disabled:!0,label:"Disabled"}},t={args:{disabled:!0,label:"Disabled",preselectedItems:["Brisket"]}},o={args:{errorNote:"Short, clear error message.",isError:!0,label:"Error",items:["Doll","Dice","Doctor","Dinger","Derby"]}},c={args:{isSuccess:!0,successNote:"Short, clear success message",label:"Success",items:["Emu","Eggplant","Envy","Essence"],preselectedItems:["Eevee"]}};e.__docgenInfo={description:"",methods:[],displayName:"Wrapping"};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {}
