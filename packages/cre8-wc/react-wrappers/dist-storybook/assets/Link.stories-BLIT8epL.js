import{j as e}from"./jsx-runtime-u17CrQMm.js";import{e as p}from"./iframe-Bcl3ePWD.js";import{g as u,c as v}from"./Cre8TertiaryNavItem-CsHMwJvg.js";import"./preload-helper-PPVm8Dsz.js";const f=`<svg fill="currentColor" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
...
`,w={title:"Cre8 Components/Link",component:u,parameters:{status:{type:"inProgress"},controls:{exclude:new RegExp(`${p.join("|")}`)}},argTypes:{href:{value:"#"},noUnderline:{control:"boolean"},ctaLink:{control:"boolean"},inverted:{control:"boolean"},iconName:{control:"text"},svg:{control:"text"},iconRotateDegree:{control:"text"},iconFlipDirection:{control:"text"},iconPosition:{options:["before","after"],control:{type:"radio"}},size:{options:["sm","lg"],control:{type:"radio"}}}},r={args:{children:e.jsx(e.Fragment,{children:"Hello World"})}},o={args:{href:"#",svg:f,iconPosition:"before",children:e.jsx(e.Fragment,{children:"Hello World"})}},n={args:{href:"#",svg:H,iconPosition:"after",children:e.jsx(e.Fragment,{children:"Hello World"})}},s={args:{href:"#",children:e.jsxs(e.Fragment,{children:["Hello World",e.jsx(v,{text:"17",slot:"badge",status:"info",variant:"light"})]})}},t={args:{href:"#",ctaLink:!0,noUnderline:!0,children:e.jsx(e.Fragment,{children:"Hello World"})}},a={args:{href:"#",ctaLink:!0,inverted:!0,noUnderline:!0,children:e.jsx(e.Fragment,{children:"Hello World"})}},l={args:{href:"#",noUnderline:!0,children:e.jsx(e.Fragment,{children:"Hello World"})}},i={args:{href:"#",noUnderline:!0,svg:h,iconPosition:"after",children:e.jsx(e.Fragment,{children:"Hello World"})}},c={args:{href:"#",inverted:!0,children:e.jsx(e.Fragment,{children:"Hello World"})},globals:{backgrounds:{value:"dark"}}},C={args:{href:"#",inverted:!0,svg:h,iconPosition:"after",children:e.jsx(e.Fragment,{children:"Hello World"})},globals:{backgrounds:{value:"dark"}}},d={args:{href:"#",size:"sm",svg:m,iconPosition:"after",children:e.jsx(e.Fragment,{children:"Hello World"})}},g={args:{href:"#",size:"lg",svg:m,iconPosition:"after",children:e.jsx(e.Fragment,{children:"Hello World"})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
  ...
  args: {
    ...
    children: <>
        Hello World
        <Cre8Badge text="17" slot="badge" status="info" variant="light"></Cre8Badge>
      </>
  }
...
}`,...g.parameters?.docs?.source}}};const V=["Default","IconBefore","IconAfter","BadgeLink","CallToActionLink","CallToActionLinkInverted","NoUnderline","NoUnderlineWithIcon","Inverted","InvtertedWithIcon","SmallLinkWithIcon","LargeLinkWithIcon"];export{s as BadgeLink,t as CallToActionLink,a as CallToActionLinkInverted,r as Default,n as IconAfter,o as IconBefore,c as Inverted,C as InvtertedWithIcon,g as LargeLinkWithIcon,l as NoUnderline,i as NoUnderlineWithIcon,d as SmallLinkWithIcon,V as __namedExportsOrder,w as default};
