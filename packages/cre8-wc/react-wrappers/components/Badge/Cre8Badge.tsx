...
export interface Cre8BadgeProps {
  ...
  status?: any;
  /** Background Style Variant  - Omitting this prop renders a badge with a dark background - **light** renders a badge with a light background - **white** renders a badge with a white background */
  variant?: any;
