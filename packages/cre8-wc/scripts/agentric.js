...
exports.rpc = void 0;
var agentrpc_1 = require("agentrpc");
var zod_1 = require("zod");
var extract_tokens_1 = require("./extract-tokens");
exports.rpc = new agentrpc_1.AgentRPC({
    apiSecret: process.env.AGENTRPC_API_SECRET,
});
exports.rpc.register({
    ...
    handler: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, extract_tokens_1.extractCssFromUrl)(url)];
