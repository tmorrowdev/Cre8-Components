(function(v,f){typeof exports=="object"&&typeof module<"u"?f(exports):typeof define=="function"&&define.amd?define(["exports"],f):(v=typeof globalThis<"u"?globalThis:v||self,f(v.Cre8Divider={}))})(this,function(v){"use strict";/**
 * @license
...
`;var Le=Object.defineProperty,de=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&Le(e,t,o),o};const X=class X extends De{constructor(){super(...arguments),this.variant="horizontal"}render(){const e=this.componentClassNames("cre8-c-divider",{"cre8-c-divider--horizontal":this.variant==="horizontal","cre8-c-divider--vertical":this.variant==="vertical","cre8-c-divider--brand":this.status==="brand","cre8-c-divider--knockout":this.status==="knockout"});return ne` <div class="${e}"><wbr></div> `}};X.styles=[je];let k=X;de([ce()],k.prototype,"variant"),de([ce()],k.prototype,"status"),customElements.get("cre8-divider")===void 0&&customElements.define("cre8-divider",k),v.Cre8Divider=k,v.default=k,Object.defineProperties(v,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
