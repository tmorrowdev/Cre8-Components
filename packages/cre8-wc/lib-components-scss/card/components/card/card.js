...
`;var Le=Object.defineProperty,de=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&Le(e,t,o),o};const K=class K extends je{render(){const e=this.componentClassNames("cre8-c-card",{"cre8-c-card--bare":this.variant==="bare","cre8-c-card--horizontal":this.variant==="horizontal","cre8-c-card--horizontal-bare":this.variant==="horizontal-bare","cre8-c-card--align-center":this.align==="center"});return N`
      <div class="${e}" part="card">
        ${this.slotNotEmpty("header")&&N`<div class="cre8-c-card__header" part="header"><slot name="header"></slot></div>`}
        <div class="cre8-c-card__body" part="body">
          <slot></slot>
        </div>
        ${this.slotNotEmpty("footer")&&N`<div class="cre8-c-card__footer" part="footer"><slot name="footer"></slot></div>`}
      </div>
    `}};K.styles=[De];let _=K;de([he()],_.prototype,"variant"),de([he()],_.prototype,"align"),customElements.get("cre8-card")===void 0&&customElements.define("cre8-card",_),b.Cre8Card=_,b.default=_,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
