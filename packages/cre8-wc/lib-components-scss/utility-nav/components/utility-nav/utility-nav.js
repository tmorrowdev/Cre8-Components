(function(v,f){typeof exports=="object"&&typeof module<"u"?f(exports):typeof define=="function"&&define.amd?define(["exports"],f):(v=typeof globalThis<"u"?globalThis:v||self,f(v.Cre8UtilityNav={}))})(this,function(v){"use strict";/**
 * @license
...
`;var De=Object.defineProperty,ye=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&De(e,t,o),o};const X=class X extends je{constructor(){super(...arguments),this.navAriaLabel="utility"}render(){const e=this.componentClassNames("cre8-c-utility-nav",{"cre8-c-utility-nav--inverted":this.inverted===!0});return ne`
      <nav aria-label="${this.navAriaLabel}" class="${e}">
        <ul class="cre8-c-utility-nav__list">
          <slot></slot>
        </ul>
      </nav>
    `}};X.styles=[Le];let _=X;ye([ce({type:Boolean,reflect:!0})],_.prototype,"inverted"),ye([ce()],_.prototype,"navAriaLabel"),customElements.get("cre8-utility-nav")===void 0&&customElements.define("cre8-utility-nav",_),v.Cre8UtilityNav=_,v.default=_,Object.defineProperties(v,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
