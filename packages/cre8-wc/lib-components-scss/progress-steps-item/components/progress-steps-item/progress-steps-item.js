...
`;var Le=Object.defineProperty,j=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&Le(e,t,o),o};const Z=class Z extends je{render(){const e=this.componentClassNames("cre8-c-progress-steps-item",{"cre8-c-progress-steps-item--complete":this.state==="complete","cre8-c-progress-steps-item--current":this.state==="current","cre8-c-progress-steps-item--error":this.state==="error","cre8-c-progress-steps-item--incomplete":this.state==="incomplete","cre8-c-progress-steps-item--warning":this.state==="warning"});return ce`
        <div class='${e}'>
        ...
        `}};Z.styles=[De];let y=Z;j([I()],y.prototype,"message"),j([I()],y.prototype,"name"),j([I()],y.prototype,"state"),j([I()],y.prototype,"svg"),customElements.get("cre8-progress-steps-item")===void 0&&customElements.define("cre8-progress-steps-item",y),b.Cre8ProgressStepsItem=y,b.default=y,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
