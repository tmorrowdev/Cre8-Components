(function(b,f){typeof exports=="object"&&typeof module<"u"?f(exports):typeof define=="function"&&define.amd?define(["exports"],f):(b=typeof globalThis<"u"?globalThis:b||self,f(b.Cre8DropdownItem={}))})(this,function(b){"use strict";/**
 * @license
...
`;var je=Object.defineProperty,De=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&je(e,t,o),o};const X=class X extends Ie{constructor(){super(...arguments),this.ariaLabel=""}_handleClick(e){this.dispatchEvent(new Event("dropdown-item-selected",e))}render(){const e=this.componentClassNames("cre8-dropdown-item",{}),t=this.ariaLabel||`Link to ${this.textContent}`||"Drop down Item";return ne`<li class="${e}" role="listitem">
        <button aria-label="${t}" @click=${this._handleClick}><slot></slot></button>
      </li>`}};X.styles=[Le];let A=X;De([Me({type:String})],A.prototype,"ariaLabel"),customElements.get("cre8-dropdown-item")===void 0&&customElements.define("cre8-dropdown-item",A),b.Cre8DropdownItem=A,b.default=A,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
