...
.cre8-c-layout {
  ...
  @media all and (min-width:$cre8-breakpoint-lg) {
    ...
    grid-template-columns: minmax(0, 1fr) calc(var(--cre8-sidebar-width, 40%) - (calc(var(--size-base-unit) * 1))); /* 2 */
  }
}
...
.cre8-c-layout--left-sidebar {
  @media all and (min-width:$cre8-breakpoint-lg) {
    grid-template-columns: calc(var(--cre8-sidebar-width, 40%) - (calc(var(--size-base-unit) * 1))) minmax(0, 1fr); /* 2 */
  }
}
`;var je=Object.defineProperty,De=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&je(e,t,o),o};const X=class X extends Ie{render(){const e=this.componentClassNames("cre8-c-layout",{"cre8-c-layout--left-sidebar":this.variant==="left-sidebar"});return ne`
      <div class="${e}">
        <slot></slot>
      </div>
    `}};X.styles=[Le];let A=X;De([Me()],A.prototype,"variant"),customElements.get("cre8-layout")===void 0&&customElements.define("cre8-layout",A),b.Cre8Layout=A,b.default=A,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
