...
`;var Le=Object.defineProperty,Z=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&Le(e,t,o),o};const G=class G extends je{render(){const e=this.componentClassNames("cre8-c-feature",{"cre8-c-feature--inverted":this.inverted===!0});return V`
      <div class="${e}" part="feature">
        <div class="cre8-c-feature__body" part="body">
          <slot></slot>
        </div>
        ${this.imgAlt?V`<div class="cre8-c-feature__media">
              <img class="cre8-c-feature__image" src=${this.imgSrc} alt=${this.imgAlt} part="image" />
            </div>`:""}
      </div>
    `}};G.styles=[De];let u=G;Z([K()],u.prototype,"imgSrc"),Z([K()],u.prototype,"imgAlt"),Z([K({type:Boolean,reflect:!0})],u.prototype,"inverted"),customElements.get("cre8-feature")===void 0&&customElements.define("cre8-feature",u),v.Cre8Feature=u,v.default=u,Object.defineProperties(v,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
