...
`;var Be=Object.defineProperty,Z=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&Be(e,t,o),o};const G=class G extends Le{render(){const e=this.componentClassNames("cre8-c-table__cell",{"cre8-c-table__cell--bare":this.variant==="bare"});return F`
      <td
        data-header="${this.dataHeader}"
        role="cell"
        colspan=${Me(this.colspan)}
        class="${e}"
      >
        ${F`<slot></slot>`}
      </td>
    `}};G.styles=[De];let u=G;Z([K({type:Number})],u.prototype,"colspan"),Z([K()],u.prototype,"variant"),Z([K()],u.prototype,"dataHeader"),customElements.get("cre8-table-cell")===void 0&&customElements.define("cre8-table-cell",u),v.Cre8TableCell=u,v.default=u,Object.defineProperties(v,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
