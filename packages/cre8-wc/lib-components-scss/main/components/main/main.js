...
`;var De=Object.defineProperty,Le=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&De(e,t,o),o};const X=class X extends Ie{render(){const e=this.componentClassNames("cre8-c-main",{"cre8-c-main--full-height":this.fullHeight===!0});return ne`<main class=${e}><slot></slot></main>`}};X.styles=[je];let A=X;Le([Me({type:Boolean,reflect:!0})],A.prototype,"fullHeight"),customElements.get("cre8-main")===void 0&&customElements.define("cre8-main",A),b.Cre8Main=A,b.default=A,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
