(function(b,f){typeof exports=="object"&&typeof module<"u"?f(exports):typeof define=="function"&&define.amd?define(["exports"],f):(b=typeof globalThis<"u"?globalThis:b||self,f(b.Cre8Footer={}))})(this,function(b){"use strict";/**
 * @license
...
.cre8-c-footer {
  ...
  color: var(--cre8-color-content-knockout);
  padding-top: calc(var(--size-base-unit) * 5);
  padding-bottom: calc(var(--size-base-unit) * 6);

  @media all and (min-width:$cre8-breakpoint-lg) {
    padding-top: calc(var(--size-base-unit) * 6.875);
  }
}
`,X=class X extends He{render(){const e=this.componentClassNames("cre8-c-footer",{});return M`
      <footer class="${e}" role="contentinfo">
        ${this.slotNotEmpty("top")&&M`<div class="cre8-c-footer__top">
        ...
        ${this.slotNotEmpty("bottom")&&M`<div class="cre8-c-footer__bottom">
          <cre8-layout-container>
            <slot name="bottom"></slot>
          </cre8-layout-container>
        </div>`}
      </footer>
    `}};X.styles=[Me];let U=X;customElements.get("cre8-footer")===void 0&&customElements.define("cre8-footer",U),b.Cre8Footer=U,b.default=U,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
