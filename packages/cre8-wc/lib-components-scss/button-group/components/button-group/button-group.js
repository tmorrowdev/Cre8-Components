...
`;var Be=Object.defineProperty,De=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&Be(e,t,o),o};const X=class X extends Ie{render(){const e=this.componentClassNames("cre8-c-button-group",{"cre8-c-button-group--responsive-full-width":this.orientation==="responsive-full-width"});return ne`
      <div class="${e}">
        <slot></slot>
      </div>
    `}};X.styles=[je];let A=X;De([Me()],A.prototype,"orientation"),customElements.get("cre8-button-group")===void 0&&customElements.define("cre8-button-group",A),b.Cre8ButtonGroup=A,b.default=A,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
