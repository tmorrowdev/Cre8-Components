...
`;var De=Object.defineProperty,Le=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&De(e,t,o),o};const K=class K extends Ie{constructor(){super(...arguments),this.heading="Page header title"}render(){const e=this.componentClassNames("cre8-c-page-header",{});return F`
      <div class="${e}">
    ...
    `}};K.styles=[je];let A=K;Le([Me({type:String})],A.prototype,"heading"),customElements.get("cre8-page-header")===void 0&&customElements.define("cre8-page-header",A),b.Cre8PageHeader=A,b.default=A,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
