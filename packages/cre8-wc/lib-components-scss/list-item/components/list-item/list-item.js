(function(b,f){typeof exports=="object"&&typeof module<"u"?f(exports):typeof define=="function"&&define.amd?define(["exports"],f):(b=typeof globalThis<"u"?globalThis:b||self,f(b.Cre8ListItem={}))})(this,function(b){"use strict";/**
 * @license
 ...
 */
`,W=class W extends He{connectedCallback(){this.setAttribute("role","listitem"),super.connectedCallback()}render(){const e=this.componentClassNames("cre8-c-list__item",{});return ne`
        <div class="${e}">
          <slot></slot>
        </div>
      `}};W.styles=[Me];let R=W;customElements.get("cre8-list-item")===void 0&&customElements.define("cre8-list-item",R),b.Cre8ListItem=R,b.default=R,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
