...
`,X=class X extends He{render(){const e=this.componentClassNames("cre8-c-table__header",{});return V`
      <thead role="rowgroup" class="${e}">
        ${V`<slot></slot>`}
      </thead>
    `}};X.styles=[Me];let U=X;customElements.get("cre8-table-header")===void 0&&customElements.define("cre8-table-header",U),b.Cre8TableHeader=U,b.default=U,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
