...
`;var De=Object.defineProperty,K=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&De(e,t,o),o};const Z=class Z extends je{constructor(){super(...arguments),this.navAriaLabel="main"}render(){const e=this.componentClassNames("cre8-c-primary-nav",{"cre8-c-primary-nav--side-by-side":this.behavior==="side-by-side","cre8-c-primary-nav--inverted":this.inverted===!0});return he`
      <nav aria-label="${this.navAriaLabel}" class="${e}">
        <ul class="cre8-c-primary-nav__list">
          <slot></slot>
        </ul>
      </nav>
    `}};Z.styles=[Le];let u=Z;K([X({type:Boolean,reflect:!0})],u.prototype,"inverted"),K([X()],u.prototype,"behavior"),K([X()],u.prototype,"navAriaLabel"),customElements.get("cre8-primary-nav")===void 0&&customElements.define("cre8-primary-nav",u),b.Cre8PrimaryNav=u,b.default=u,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
