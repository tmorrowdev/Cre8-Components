...
`;var De=Object.defineProperty,Le=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&De(e,t,o),o};const K=class K extends Ie{render(){const e=this.componentClassNames("cre8-c-section",{});return N`
      <section class="${e}">
        ${this.headline?N`<header class="cre8-c-section__header">
              <cre8-heading tagVariant="h2">${this.headline}</cre8-heading>
              <slot name="header"></slot>
            </header>`:N`<header class="cre8-c-section__header">
              <slot name="header"></slot>
            </header>`}
    ...
    `}};K.styles=[je];let A=K;Le([Me()],A.prototype,"headline"),customElements.get("cre8-section")===void 0&&customElements.define("cre8-section",A),b.Cre8Section=A,b.default=A,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
