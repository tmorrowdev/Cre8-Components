(function(b,f){typeof exports=="object"&&typeof module<"u"?f(exports):typeof define=="function"&&define.amd?define(["exports"],f):(b=typeof globalThis<"u"?globalThis:b||self,f(b.Cre8LayoutContainer={}))})(this,function(b){"use strict";/**
 * @license
...
`;var Le=Object.defineProperty,De=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&Le(e,t,o),o};const X=class X extends Ie{render(){const e=this.componentClassNames("cre8-l-layout-container",{"cre8-l-layout-container--full-height":this.fullHeight===!0});return ne`
      <div class="${e}">
        <slot></slot>
      </div>
    `}};X.styles=[je];let A=X;De([Me({type:Boolean,reflect:!0})],A.prototype,"fullHeight"),customElements.get("cre8-layout-container")===void 0&&customElements.define("cre8-layout-container",A),b.Cre8LayoutContainer=A,b.default=A,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
