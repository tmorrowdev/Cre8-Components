...
`;var De=Object.defineProperty,Le=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&De(e,t,o),o};const K=class K extends Ie{render(){const e=this.componentClassNames("cre8-c-submenu-item",{});return this.href?F`
      ...
      </li>`}};K.styles=[je];let A=K;Le([Me()],A.prototype,"href"),customElements.get("cre8-submenu-item")===void 0&&customElements.define("cre8-submenu-item",A),b.Cre8SubmenuItem=A,b.default=A,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
