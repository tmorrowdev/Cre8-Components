(function(b,f){typeof exports=="object"&&typeof module<"u"?f(exports):typeof define=="function"&&define.amd?define(["exports"],f):(b=typeof globalThis<"u"?globalThis:b||self,f(b.Cre8Breadcrumbs={}))})(this,function(b){"use strict";/**
 * @license
...
`;var Le=Object.defineProperty,De=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&Le(e,t,o),o};const X=class X extends Ie{constructor(){super(...arguments),this.navAriaLabel="breadcrumbs"}render(){const e=this.componentClassNames("cre8-c-breadcrumbs",{});return ne`
      <nav aria-label="${this.navAriaLabel}"  class="${e}">
        <ol class="cre8-c-breadcrumbs__list">
          <slot></slot>
        </ol>
      </nav>
    `}};X.styles=[je];let A=X;De([Me()],A.prototype,"navAriaLabel"),customElements.get("cre8-breadcrumbs")===void 0&&customElements.define("cre8-breadcrumbs",A),b.Cre8Breadcrumbs=A,b.default=A,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
