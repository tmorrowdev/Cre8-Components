...
`;var Le=Object.defineProperty,ye=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&Le(e,t,o),o};const X=class X extends je{constructor(){super(...arguments),this.top="1rem"}render(){const e=this.componentClassNames("cre8-c-layout-section",{"cre8-c-layout-section--sticky":this.behavior==="sticky"});return ne`
      <div class="${e}" style=${`top: ${this.top}`}>
        <slot></slot>
      </div>
    `}};X.styles=[De];let _=X;ye([ce()],_.prototype,"behavior"),ye([ce()],_.prototype,"top"),customElements.get("cre8-layout-section")===void 0&&customElements.define("cre8-layout-section",_),b.Cre8LayoutSection=_,b.default=_,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
