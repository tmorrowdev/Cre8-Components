...
.cre8-c-table__header-cell {
  ...
  text-align: left;
}`;var Be=Object.defineProperty,de=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&Be(e,t,o),o};const K=class K extends Le{render(){const e=this.componentClassNames("cre8-c-table__header-cell",{});return F`
      <th
        role="columnheader"
        colspan=${pe(this.colspan)}
        class="${e}"
        style="width: ${pe(this.width)}"
      >
        ${F`<slot></slot>`}
      </th>
    `}};K.styles=[De];let _=K;de([ce()],_.prototype,"colspan"),de([ce()],_.prototype,"width"),customElements.get("cre8-table-header-cell")===void 0&&customElements.define("cre8-table-header-cell",_),b.Cre8TableHeaderCell=_,b.default=_,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
