...
`;var Be=Object.defineProperty,ye=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&Be(e,t,o),o};const X=class X extends De{firstUpdated(){this._initializeAria()}_initializeAria(){this.fieldId=this.fieldId||He()}render(){const e=this.componentClassNames("cre8-c-tag-list",{});return ne`
      <fieldset class="${e}">
      ...
      `}};X.styles=[Le];let _=X;ye([ce()],_.prototype,"label"),ye([ce()],_.prototype,"fieldId"),customElements.get("cre8-tag-list")===void 0&&customElements.define("cre8-tag-list",_),b.Cre8TagList=_,b.default=_,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
