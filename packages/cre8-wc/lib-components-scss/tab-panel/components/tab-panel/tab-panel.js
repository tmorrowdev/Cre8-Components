...
`;var qe=Object.defineProperty,I=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&qe(e,t,o),o};const Z=class Z extends Le{firstUpdated(){this.skipFocusOnPanel||this._Cre8TabPanel.setAttribute("tabindex","0")}render(){const e=this.componentClassNames("cre8-c-tab-panel",{"cre8-is-active":this.isActive});return he`
      <div role="tabpanel" class="${e}">
        <slot></slot>
      </div>
    `}};Z.styles=[De];let d=Z;I([K({type:Boolean,reflect:!0})],d.prototype,"skipFocusOnPanel"),I([K({type:Boolean,reflect:!0})],d.prototype,"isActive"),I([K({type:Number})],d.prototype,"index"),I([Ne(".cre8-c-tab-panel")],d.prototype,"_Cre8TabPanel"),customElements.get("cre8-tab-panel")===void 0&&customElements.define("cre8-tab-panel",d),v.Cre8TabPanel=d,v.default=d,Object.defineProperties(v,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
