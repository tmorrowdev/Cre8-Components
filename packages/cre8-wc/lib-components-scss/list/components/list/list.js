(function(b,f){typeof exports=="object"&&typeof module<"u"?f(exports):typeof define=="function"&&define.amd?define(["exports"],f):(b=typeof globalThis<"u"?globalThis:b||self,f(b.Cre8List={}))})(this,function(b){"use strict";/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ye;const f=globalThis,L=f.ShadowRoot&&(f.ShadyCSS===void 0||f.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,j=Symbol(),G=new WeakMap;let K=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==j)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(L&&e===void 0){const r=t!==void 0&&t.length===1;r&&(e=G.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&G.set(t,e))}return e}toString(){return this.cssText}};const fe=a=>new K(typeof a=="string"?a:a+"",void 0,j),ge=(a,...e)=>{const t=a.length===1?a[0]:e.reduce((r,o,i)=>r+(l=>{if(l._$cssResult$===!0)return l.cssText;if(typeof l=="number")return l;throw Error("Value passed to 'css' function must be a 'css' function result: "+l+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(o)+a[i+1],a[0]);return new K(t,a,j)},me=(a,e)=>{if(L)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const t of e){const r=document.createElement("style"),o=f.litNonce;o!==void 0&&r.setAttribute("nonce",o),r.textContent=t.cssText,a.appendChild(r)}},Z=L?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(const r of e.cssRules)t+=r.cssText;return fe(t)})(a):a;/**
 * @license
...
::slotted(cre8-list-item) {
  ...
  */
  .cre8-c-list--condensed & {
    padding-top: calc(var(--size-base-unit) * 1);
...
`;var De=Object.defineProperty,de=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&De(e,t,o),o};const X=class X extends Le{render(){const e=this.componentClassNames("cre8-c-list",{"cre8-c-list--bare":this.variant==="bare","cre8-c-list--padded":this.spacing==="padded","cre8-c-list--condensed":this.spacing==="condensed"});return ne`
      <ul class="${e}">
        <slot></slot>
      </ul>
    `}};X.styles=[je];let _=X;de([ce()],_.prototype,"variant"),de([ce()],_.prototype,"spacing"),customElements.get("cre8-list")===void 0&&customElements.define("cre8-list",_),b.Cre8List=_,b.default=_,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
