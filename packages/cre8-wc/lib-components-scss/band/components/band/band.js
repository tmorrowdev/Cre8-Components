...
.cre8-c-band {
  ...
  padding: calc(var(--size-base-unit) * 3) 0;
...
`;var De=Object.defineProperty,ye=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&De(e,t,o),o};const X=class X extends je{render(){const e=this.componentClassNames("cre8-c-band",{"cre8-c-band--branded":this.variant==="branded","cre8-c-band--full-height":this.fullHeight===!0});return ne`
      <div class="${e}">
        <slot></slot>
      </div>
    `}};X.styles=[Be];let k=X;ye([ce()],k.prototype,"variant"),ye([ce({type:Boolean,reflect:!0})],k.prototype,"fullHeight"),customElements.get("cre8-band")===void 0&&customElements.define("cre8-band",k),b.Cre8Band=k,b.default=k,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
