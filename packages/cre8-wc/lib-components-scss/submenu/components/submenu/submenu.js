...
`,W=class W extends Re{render(){const e=this.componentClassNames("cre8-c-submenu",{});return ne`
      <ul role="list" class="${e}">
        <slot></slot>
      </ul>
    `}};W.styles=[He];let M=W;customElements.get("cre8-submenu")===void 0&&customElements.define("cre8-submenu",M),b.Cre8Submenu=M,b.default=M,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
