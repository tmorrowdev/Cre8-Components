...
`;var De=Object.defineProperty,K=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&De(e,t,o),o};const Z=class Z extends Le{constructor(){super(...arguments),this.variant="rectangle"}render(){const e=this.componentClassNames("cre8-c-skeleton-loader",{"cre8-c-skeleton-loader--rectangle":this.variant==="rectangle","cre8-c-skeleton-loader--square":this.variant==="square","cre8-c-skeleton-loader--circle":this.variant==="circle"});return he`
    <div
        class="${e}"
        style="height: ${this.height??"auto"}; width: ${this.width??"auto"}"
    ></div>
    `}};Z.styles=[je];let u=Z;K([X()],u.prototype,"variant"),K([X()],u.prototype,"height"),K([X()],u.prototype,"width"),customElements.get("cre8-skeleton-loader")===void 0&&customElements.define("cre8-skeleton-loader",u),v.Cre8SkeletonLoader=u,v.default=u,Object.defineProperties(v,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
