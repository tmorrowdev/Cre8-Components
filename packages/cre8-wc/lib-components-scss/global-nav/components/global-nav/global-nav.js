...
`;var Be=Object.defineProperty,G=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&Be(e,t,o),o};const K=class K extends Le{constructor(){super(...arguments),this.navAriaLabel="global"}render(){const e=this.componentClassNames("cre8-c-global-nav",{"cre8-c-global-nav--side-by-side":this.behavior==="side-by-side","cre8-c-global-nav--inverted":this.inverted===!0});return he`
      <nav aria-label="${this.navAriaLabel}" class="${e}">
        <ul class="cre8-c-global-nav__list">
          <slot></slot>
        </ul>
      </nav>
    `}};K.styles=[je];let u=K;G([X({type:Boolean,reflect:!0})],u.prototype,"inverted"),G([X()],u.prototype,"behavior"),G([X()],u.prototype,"navAriaLabel"),customElements.get("cre8-global-nav")===void 0&&customElements.define("cre8-global-nav",u),v.Cre8GlobalNav=u,v.default=u,Object.defineProperties(v,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
