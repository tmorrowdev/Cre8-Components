...
.cre8-c-tertiary-nav {
  width: 100%;
  max-width: calc(var(--size-base-unit) * 30);
}
...
`;var De=Object.defineProperty,ye=(a,e,t,r)=>{for(var o=void 0,i=a.length-1,l;i>=0;i--)(l=a[i])&&(o=l(e,t,o)||o);return o&&De(e,t,o),o};const X=class X extends je{constructor(){super(...arguments),this.navAriaLabel="tertiary"}render(){const e=this.componentClassNames("cre8-c-tertiary-nav",{"cre8-c-tertiary-nav--full-width":this.fullWidth});return ne`
      <nav aria-label="${this.navAriaLabel}" role="navigation" class="${e}">
        <ul role="list" class="cre8-c-tertiary-nav__list">
          <slot></slot>
        </ul>
      </nav>
    `}};X.styles=[Le];let _=X;ye([ce({type:Boolean,reflect:!0})],_.prototype,"fullWidth"),ye([ce()],_.prototype,"navAriaLabel"),customElements.get("cre8-tertiary-nav")===void 0&&customElements.define("cre8-tertiary-nav",_),v.Cre8TertiaryNav=_,v.default=_,Object.defineProperties(v,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
