...
`,X=class X extends He{render(){const e=this.componentClassNames("cre8-c-table__body",{});return V`
      <tbody role="rowgroup" class="${e}">
        ${V`<slot></slot>`}
      </tbody>
    `}};X.styles=[Me];let R=X;customElements.get("cre8-table-body")===void 0&&customElements.define("cre8-table-body",R),b.Cre8TableBody=R,b.default=R,Object.defineProperties(b,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
