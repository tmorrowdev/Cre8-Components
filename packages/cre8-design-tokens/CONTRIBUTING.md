...
See [package.json](https://github.com/tmorrowdev/cre8-web-components/blob/develop/package.json) and [README.md](https://github.com/tmorrowdev/cre8-web-components/blob/develop/README.md) for full list of project dependencies.
