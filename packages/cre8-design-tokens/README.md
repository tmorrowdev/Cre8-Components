...
> [View the Storybook for this project](https://static-dev.esi-memberweb-dev.aws.cre8cloud.com/cre8-design-tokens/)
...
`@import '@esi/cre8-design-tokens/lib/web/brands/brand-name/tokens-brand.scss';`
```
...
```
// Replace `brand-name` with the brand name your project needs
@import '@esi/cre8-design-tokens/lib/web/brands/brand-name/css/tokens-brand.css';
```
...
```
// Replace `brand-name` with the brand name your project needs
@import '@esi/cre8-design-tokens/lib/web/brands/brand-name/accent.scss';
```
...
```
// Replace `brand-name` with the brand name your project needs
@import '@esi/cre8-design-tokens/lib/web/brands/brand-name/css/tokens_accent.css';
```
...
- Beta Version: https://www-dev-candidate.express-scripts.com/cre8-design-tokens/ 
- Released Version: https://static-dev.esi-memberweb-dev.aws.cre8cloud.com/cre8-design-tokens/ 
