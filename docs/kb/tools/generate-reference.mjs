...
const intents = [
  ...
  ['how do I stream ui instead of returning markup', '08-streaming-ui.md'],
  ['how does an agent update ui without re-rendering', '08-streaming-ui.md#the-ops'],
  ['what is a surface', '08-streaming-ui.md'],
  ['how do I stream tokens into a component', '08-streaming-ui.md#streaming-text-is-the-op-that-matters'],
  ['how do I bind a prop to a data model', '08-streaming-ui.md#binding-props-to-a-data-model'],
  ['how do I get a click back from generated ui', '08-streaming-ui.md#events-come-back-the-same-way-they-always-did'],
